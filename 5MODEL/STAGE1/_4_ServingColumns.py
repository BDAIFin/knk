...
STAGE1_FEATURES_AVAILABLE = [
    ...
    # 3) Fraud history (label exists in df)
    "card_fraud_last1",
    "client_fraud_last1",
    "card_fraud_last3",
    ...
    # 5) Velocity (can be derived from date + card_id/client_id)
    "seconds_since_prev_tx",
    "card_velocity_spike_ratio",

    # 6) MCC / Merchant novelty (can be derived from ids + mcc)
    "card_mcc_is_new",
    "client_mcc_is_new",
